...
public class StudentListActivity extends AppCompatActivity implements StudentCreateListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_delete){
            ...
            alertDialogBuilder.setMessage("Apakah anda yakin menghapus semua data?");
    ...
    private void openStudentCreateDialog() {
        StudentCreateDialogFragment studentCreateDialogFragment = StudentCreateDialogFragment.newInstance("Daftar Baru", this);
